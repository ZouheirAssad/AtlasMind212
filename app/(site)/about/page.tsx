...
export const metadata: Metadata = {
  ...
  description: "Learn how AtlasMind delivers web applications, backend systems, technical consulting, integrations, and workflow automation with clear scopes and documented handoff.",
  alternates: { canonical: "/about" },
  openGraph: { title: "About AtlasMind", description: "Reliable digital systems built with clear scopes and documented handoff.", url: absoluteUrl("/about"), type: "website" },
};
      ...
      <section className="bg-white py-20 sm:py-28">
        <Container className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <Reveal>
            ...
            <h2 className="mt-5 text-balance text-5xl leading-[1.02] text-display-brand sm:text-7xl">Smarter operations, not more complexity.</h2>
          </Reveal>
          <Reveal delay={0.08} className="space-y-5 text-lg leading-8 text-muted-foreground">
            ...
            <p>AtlasMind works at the implementation layer: clarifying the useful outcome, connecting the required tools, testing the edge cases, and documenting how everything is owned.</p>
